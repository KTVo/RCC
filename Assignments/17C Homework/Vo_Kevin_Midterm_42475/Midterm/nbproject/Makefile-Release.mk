...
${OBJECTDIR}/Prob10_PowerFunct.o: Prob10_PowerFunct.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Prob10_PowerFunct.o Prob10_PowerFunct.cpp

${OBJECTDIR}/Prob12_MutualRecursion.o: Prob12_MutualRecursion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Prob12_MutualRecursion.o Prob12_MutualRecursion.cpp

${OBJECTDIR}/Prob13_Set_Map.o: Prob13_Set_Map.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Prob13_Set_Map.o Prob13_Set_Map.cpp

${OBJECTDIR}/Prob1_LinearBinary.o: Prob1_LinearBinary.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Prob1_LinearBinary.o Prob1_LinearBinary.cpp

${OBJECTDIR}/Prob2_Bubble_Selection_Sort.o: Prob2_Bubble_Selection_Sort.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Prob2_Bubble_Selection_Sort.o Prob2_Bubble_Selection_Sort.cpp

${OBJECTDIR}/Prob8_Dices.o: Prob8_Dices.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Prob8_Dices.o Prob8_Dices.cpp

${OBJECTDIR}/Prob9_BitVector.o: Prob9_BitVector.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Prob9_BitVector.o Prob9_BitVector.cpp

${OBJECTDIR}/Prob_11.o: Prob_11.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Prob_11.o Prob_11.cpp

${OBJECTDIR}/Prob_3_ALL_3_SimpleVectors.o: Prob_3_ALL_3_SimpleVectors.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Prob_3_ALL_3_SimpleVectors.o Prob_3_ALL_3_SimpleVectors.cpp
...
${OBJECTDIR}/prob7_Fib.o: prob7_Fib.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/prob7_Fib.o prob7_Fib.cpp
