...
int main(int argc, char** argv) {
    ...
    float nOmega=exp(lognCm(69,5))*exp(lognCm(26,1));
    float n5notM=exp(lognCm(5,5))*exp(lognCm(25,1));
    float n4M=exp(lognCm(5,4))*exp(lognCm(64,1))*exp(lognCm(1,1));
    float n4notM=exp(lognCm(5,4))*exp(lognCm(64,1))*exp(lognCm(25,1));
    float n3M=exp(lognCm(5,3))*exp(lognCm(64,2))*exp(lognCm(1,1));
    float n3notM=exp(lognCm(5,3))*exp(lognCm(64,2))*exp(lognCm(25,1));
    float n2M=exp(lognCm(5,2))*exp(lognCm(64,3))*exp(lognCm(1,1));
    float n2notM=exp(lognCm(5,2))*exp(lognCm(64,3))*exp(lognCm(25,1));
    float n1M=exp(lognCm(5,1))*exp(lognCm(64,4))*exp(lognCm(1,1));
    float n1notM=exp(lognCm(5,1))*exp(lognCm(64,4))*exp(lognCm(25,1));
    float n0M=exp(lognCm(5,0))*exp(lognCm(64,5))*exp(lognCm(1,1));
    float n0notM=exp(lognCm(5,0))*exp(lognCm(64,5))*exp(lognCm(25,1));
