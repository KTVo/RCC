...
int main(int argc, char** argv) {
    ...
    double nOmega=exp(lognCm(69,5)+lognCm(26,1));
    double n5notM=exp(lognCm(5,5)+lognCm(25,1));
    double n4M=exp(lognCm(5,4)+lognCm(64,1)+lognCm(1,1));
    double n4notM=exp(lognCm(5,4)+lognCm(64,1)+lognCm(25,1));
    double n3M=exp(lognCm(5,3)+lognCm(64,2)+lognCm(1,1));
    double n3notM=exp(lognCm(5,3)+lognCm(64,2)+lognCm(25,1));
    double n2M=exp(lognCm(5,2)+lognCm(64,3)+lognCm(1,1));
    double n2notM=exp(lognCm(5,2)+lognCm(64,3)+lognCm(25,1));
    double n1M=exp(lognCm(5,1)+lognCm(64,4)+lognCm(1,1));
    double n1notM=exp(lognCm(5,1)+lognCm(64,4)+lognCm(25,1));
    double n0M=exp(lognCm(5,0)+lognCm(64,5)+lognCm(1,1));
    double n0notM=exp(lognCm(5,0)+lognCm(64,5)+lognCm(25,1));
